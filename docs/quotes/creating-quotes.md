...
1. Open a lead from your Leads list
2. Click **"Create Quote"** button
3. Select packages that match what they need
4. Add relevant add-ons (optional extras)
5. Configure payment schedule (when payments are due)
6. Add a personal note (optional but recommended)
7. Preview how it looks to your client
8. Click **"Send Quote"**

<!-- TODO: Add screenshot -->
<!-- ![Quote creation form](../../static/img/screenshots/quotes/quote-creation.png) -->
...
**1. Packages**
Your core service offerings (wedding packages, portrait sessions, etc.). Set these up in Settings > Packages.

**2. Add-ons**
Optional extras like extra hours, second photographer, albums. Also configured in Settings > Packages.

**3. Payment Schedules (Optional)**
Pre-defined payment structures you can reuse. You can also create custom schedules per quote.
...
<!-- TODO: Add screenshot -->
<!-- ![Package selection](../../static/img/screenshots/quotes/package-selection.png) -->

The quote builder shows all your available packages. Select the package (or packages) that match what the client asked for.

**Single Package:**
Most quotes include just one package - the one that best fits their needs. This keeps it simple and focused.

**Multiple Packages:**
You can include 2-3 packages if you want to give them options (good, better, best). This lets them choose based on budget and needs.
...
**Example:**
Client wants family portraits and mentioned a 1-hour session. You'd select your "Standard Portrait Session" package rather than a mini session or extended session.
...
<!-- TODO: Add screenshot -->
<!-- ![Payment schedule configuration](../../static/img/screenshots/quotes/payment-schedule.png) -->
...
**Session Date:**
When is the shoot happening? This should be filled in from the lead, but double-check it!
...
**Notes to Yourself:**
Internal notes that only you see (not visible to client). Use this for:
...
<!-- TODO: Add screenshot -->
<!-- ![Quote preview](../../static/img/screenshots/quotes/quote-preview.png) -->
...
**1. Email Sent to Client**
They receive a beautifully formatted email with:
...
The lead status changes from "New" to "Quoted" so you know where things stand.

**3. Quote Tracking Starts**
ShootPath starts tracking:
- When the quote was sent
- How many days it's been pending
- Whether the client has viewed it

**4. Notification for You**
...
Usually yes! You can adjust packages, swap add-ons, or create a custom quote based on their specific needs.

**"When do we need to decide?"**
Check if you set an expiration date on the quote. If not, let them know when their date might no longer be available.

**"What's included in editing?"**
Have a clear answer ready: "All photos are professionally color-corrected, exposure-adjusted, and run through my signature style. You'll receive high-resolution digital files."

**"Can we pay in installments?"**
That's what the payment schedule is for! Walk them through when each payment is due.

**"What if we need to reschedule?"**
Point them to your contract, which covers cancellation and rescheduling policies.
...
**Example:**
If you charge $2,500 for an 8-hour wedding, don't price "extra hour" at $50 - that devalues your time. Price it at $200-300/hour to properly reflect your value.
...
❌ Sending 5 package options and 15 add-ons overwhelms clients.
✅ Send 1-2 packages and 3-5 relevant add-ons keeps it simple.
...
✅ "I love that you're planning an outdoor ceremony at sunset - golden hour photos are my favorite!"
...
**Track your quotes** → [Managing Quotes](./managing-quotes)

**Customize quote appearance** → [Quote Templates](./quote-templates)
