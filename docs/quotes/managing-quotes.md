...
**What it means:**
You've sent the quote and it's with your client. They're reviewing it and deciding whether to book.
...
**When to worry:**
If it's been 10+ days with no response, they may have gone with someone else or postponed. Send a final check-in, then consider marking the lead lost if still no response.

#### Accepted

**What it means:**
The client clicked "Accept Quote" - you got the booking! 🎉
...
**What it means:**
The client decided not to book with you. This happens - not every quote converts!
...
**What it means:**
You set an expiration date and the quote expired without client response.
...
**Day 0 - Send Quote**
Send the quote and give them time to review. Don't expect an immediate response!

**Day 3-5 - First Check-In**
Friendly reminder to see if they have questions.

**Day 7-10 - Second Check-In**
Offer to clarify packages or pricing.

**Day 14+ - Final Check-In**
One last reach-out before marking lost.
...
"Your date is currently available! I have it penciled in for you, but I do book up
quickly for fall weekends. If you'd like to move forward, we can get you officially
booked with the contract and deposit."
...
"All photos are professionally edited with my signature style - that includes color
correction, exposure adjustments, skin retouching, and artistic enhancements. You'll
receive high-resolution digital files ready to print or share. Turnaround time is
[X weeks]."

#### "Can we pay in installments?"

**Answer:** "Yes! The payment schedule is built into the quote. You'll pay [amount] at
booking to secure your date, then [amount] on [date]. This makes it easier to manage!"

Walk them through the payment schedule that's already in the quote.

#### "What if we need to reschedule?"

**Answer:** "Great question! My contract covers rescheduling and cancellation policies.
The short version: [brief explanation]. Once you accept the quote and review the contract,
...
**Answer:** "Absolutely! Here are some recent galleries similar to what you're looking for:
[links]. You can also see more on my Instagram [@handle] and website [url]."
...
:::warning Be Careful Editing Quotes
