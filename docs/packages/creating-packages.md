...
2. Click **"+ New Package"**
3. Fill in the package details (name, price, deliverables)
4. Choose which job type(s) it applies to
5. Save and it's ready to use on quotes!
...
**Next Steps:** Learn about [pricing strategies](./pricing-strategies) or [add-ons](./add-ons).
...
3. Click **Packages & Add-Ons** from the settings menu
4. You'll see your current package list (empty if you're just starting)
...
Don't just say "8 hours." Say "I'll be there from the moment you slip into your dress until your magical sparkler send-off."
...
**When to skip it:**
If the package isn't time-based (like a product package for prints/albums with no session time), you can leave this blank.
...
**Image placement:**
You can choose to place the image above or below the description. Most photographers use "above" so the image is the first thing clients see.

:::tip Optional but Effective
...
1. Create the package with special pricing
2. Use it for the limited time
3. Mark it inactive when the special ends
...
**Want to fine-tune your pricing?** Read [Pricing Strategies](./pricing-strategies)
